...
# 查看服务器状态
curl http://192.168.1.34:8765/health

# 查看统计
curl http://192.168.1.34:8765/stats

# 查看Prometheus指标
curl http://192.168.1.34:8765/metrics
```
...
```bash
# 测试工具列表
curl -X POST http://192.168.1.34:8765/ \
